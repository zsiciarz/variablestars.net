...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Observer.location'
        db.add_column(u'observers_observer', 'location',
                      self.gf('geoposition.fields.GeopositionField')(default='0,0', max_length=42),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Observer.location'
        db.delete_column(u'observers_observer', 'location')
    ...
    models = {
        ...
        u'observers.observer': {
            ...
            'location': ('geoposition.fields.GeopositionField', [], {'default': "'0,0'", 'max_length': '42'}),
