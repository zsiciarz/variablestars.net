...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Star.variability_type'
        db.add_column(u'stars_star', 'variability_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['stars.VariabilityType'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Star.variability_type'
        db.delete_column(u'stars_star', 'variability_type_id')
