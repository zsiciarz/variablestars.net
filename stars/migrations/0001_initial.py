...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('code', models.CharField(max_length=12, verbose_name='Letter code', db_index=True)),
                ('short_description', models.CharField(default='', max_length=100, verbose_name='Short description', blank=True)),
                ('long_description', models.TextField(default='', verbose_name='Long description')),
            ],
            options={
                'ordering': ('code',),
